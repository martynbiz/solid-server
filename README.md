...
This pulls `solidproject/community-server:latest`, starts it on port `3000`, and persists all pod data to `./data` on your machine (see `docker-compose.yml`). Data survives container restarts/rebuilds since it's a bind-mounted volume.
...
### 6. Try a Solid app against your pod
